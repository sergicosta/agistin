...
model.P_g  = pyo.Var(model.t, within=pyo.NonNegativeReals, bounds=(0.0, P_max),  initialize={k:1.0 for k in range(n)},)
model.P_e  = pyo.Var(model.t, within=pyo.NonNegativeReals, bounds=(0.0, P_max),  initialize={k:4.0 for k in range(n)},)
model.P_h  = pyo.Var(model.t, within=pyo.NonNegativeReals, bounds=(0.0, P_max),  initialize={k:4.0 for k in range(n)},)
model.Ppvu = pyo.Var(model.t, within=pyo.NonNegativeReals, bounds=(0.0, 15), initialize={k:1e-3 for k in range(n)})
