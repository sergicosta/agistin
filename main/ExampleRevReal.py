"""
AGISTIN - EXAMPLE Reversible and real Pump

Optimization usage example of two reservoirs, considering irragtion consumption,
and one reversible pump with working limits, connected to the electrical grid, 
to a PV plant and a to battery bank.

In this example is tested the correct working of the reversible pump with water
flow limits (Real Pump).
...
data_res0 = {'W0':10, 'Wmin':0, 'Wmax':20,'zmin':0,'zmax':3,'dt':1}
data_res1 = {'W0':5, 'Wmin':0, 'Wmax':10,'zmin':20,'zmax':30,'dt':1}
