...
def HydroSwitch(b, t, data=None, init_data=None):
    ...
    Computes the output flow :math:`Q_{out}(t)` between 2 inputs of flow :math:`Q_{in,0}(t)` and :math:`Q_{in,1}(t)` , analogous of an electrical switch
    ...
    Pyomo declarations    
        ...
        - Constraints: 
            ...
            - c_Hout: :math:`- H_{out}(t) + H_{in,1}(t) \, b(t) + H_{in,0}(t) \, (1-b(t)) = 0`
            - c_Qin0: :math:`Q_{in,0}(t) \, H_{in,1}(t) \, b(t) = 0`
            - c_Qin1: :math:`Q_{in,1}(t) \, H_{in,0}(t) \, (1-b(t)) = 0`
