...
data_filename = "ExampleBatteryPV48H"
...
# time
l_t = list(range(48)) #999 #TODO this should be inferred from the number of rows in the excel time series,
...
cost_new_battery_MW  = 400
cost_new_battery_MWh = 100
cost_new_pv = 10

cost_P_Add_Charge = 0 # Euros/day
#ost_new_BESS_ = 200
...
options = {'mumps_icntl_13': 64000}  # Example: start with a larger value
