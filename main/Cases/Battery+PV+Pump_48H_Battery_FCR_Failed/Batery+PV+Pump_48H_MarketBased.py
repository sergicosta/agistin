...
data_filename = "ExampleBatteryPumpPV"
...
# time
l_t = list(range(48)) #TODO this should be inferred from the number of rows in the excel time series,
...
cost_new_battery_MW  = 1000# Euros/day 100 70
cost_new_battery_MWh = 0 # Euros/day   90 40
