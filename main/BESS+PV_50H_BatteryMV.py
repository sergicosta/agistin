...
data_filename = "BESS+V_50H_BatteryMV"
...
# time
l_t = list(range(50)) #TODO this should be inferred from the number of rows in the excel time series,
...
#""
cost_new_battery_MW  = 500 #900
cost_new_battery_MWh = 500 #400
cost_new_pv = 100
cost_FCR_reBAP_pos = 1.5
cost_FCR_reBAP_neg = -1.5
cost_FCR_Remuneration = 50
